export const LOGO_URL = '/LogoIntercert.png'

export const FAVICON_URL = '/favicon-128x128.png'
...
export const DASHBOARD_LOGO_URL = '/partners-logo-blanco.png'
...
export type { AuditorRequestStatus, PartnerUser, UserRole } from './auth'
